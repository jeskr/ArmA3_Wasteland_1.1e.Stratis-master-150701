...
spawnActionHandle = (_this select 1) spawn
{
	...
	if (isNil "playerData_resetPos") then
	{
		...
		{
			case 1: { player setVariable ["cmoney", _baseMoney + 1000, true]; };
			case 2: { player setVariable ["cmoney", _baseMoney + 2000, true]; [MF_ITEMS_REPAIR_KIT, 1] call mf_inventory_add; };	//SWWD Loadout
			case 3: { player setVariable ["cmoney", _baseMoney + 3000, true]; };
			case 4: { player setVariable ["cmoney", _baseMoney + 3000, true]; };
			case 5: { player setVariable ["cmoney", _baseMoney + 3000, true]; };
			case 6: { player setVariable ["cmoney", _baseMoney + 3000, true]; };
			case 7: { player setVariable ["cmoney", _baseMoney + 5000, true]; [MF_ITEMS_REPAIR_KIT, 1] call mf_inventory_add; };
			case 8: { player setVariable ["cmoney", _baseMoney + 5000, true]; [MF_ITEMS_REPAIR_KIT, 1] call mf_inventory_add; };
			case 9: { player setVariable ["cmoney", _baseMoney + 5000, true]; [MF_ITEMS_REPAIR_KIT, 1] call mf_inventory_add; };
			case 10: { player setVariable ["cmoney", _baseMoney + 5000, true];[MF_ITEMS_REPAIR_KIT, 1] call mf_inventory_add; };  // ADMIN Loadout
			case 11: { player setVariable ["cmoney", _baseMoney + 5000, true];[MF_ITEMS_REPAIR_KIT, 1] call mf_inventory_add; };
			case 12: { player setVariable ["cmoney", _baseMoney + 5000, true];[MF_ITEMS_REPAIR_KIT, 1] call mf_inventory_add; };
