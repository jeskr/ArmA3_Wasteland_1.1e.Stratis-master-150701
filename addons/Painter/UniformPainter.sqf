...
if (_paint == 5) then {
player setObjectTextureGlobal  [0, _texDir + "carbon.paa"]; backpackContainer player setObjectTextureGlobal  [0, _texDir + "carbon.paa"];
};
...
if (_paint == 9) then {
player setObjectTextureGlobal  [0, _texDir + "hippie.paa"]; backpackContainer player setObjectTextureGlobal  [0, _texDir + "hippie.paa"];
};
