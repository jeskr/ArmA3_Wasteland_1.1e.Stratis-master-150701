...
_generalInfoString = "Website: <t color='#0091CD'><a href='http://www.gamersinc.co.uk'>GamersInc.</a></t> Forums: <t color='#0091CD'><a href='http://www.gamersinc.co.uk/forums'>GamersInc. Forums</a></t> TeamSpeak: ts.gamersinc.co.uk";
